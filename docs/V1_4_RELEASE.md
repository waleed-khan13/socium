...
Release readiness: complete for v1.4.1.
...
- Release verification requires consistent v1.4.1 versions, dependency/security checks, a production Next.js build, and native installer matrix smoke tests before tagging.

## Native artifacts

- Windows x64: `Socium-Setup-1.4.1.exe`
- Windows ARM64: `Socium-Setup-1.4.1-arm64.exe`
- macOS Apple silicon: `Socium-1.4.1.dmg`
- macOS Intel: `Socium-1.4.1-intel.dmg`
- Linux x64: `Socium-1.4.1.AppImage`
- Linux ARM64: `Socium-1.4.1-arm64.AppImage`
