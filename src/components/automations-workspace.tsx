...
function initialForm(state: PublicAppState): AutomationForm {
  ...
  return {
    ...
    channel,
    topic: state.contentDefaults.topic || "Share useful, factual insights about our business and customer problems.",
    tone: state.contentDefaults.tone || "Clear and confident",
    objective: state.contentDefaults.objective || "Build useful awareness",
